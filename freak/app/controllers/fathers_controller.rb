class FathersController < ApplicationController
  ...
  before_action :authenticate_father!, except: [:show,:index]
  # GET /fathers
  # GET /fathers.json
  def index
    @fathers = Father.all
  ...
  def create
    ...
    respond_to do |format|
      if @father.save
        ...
        format.html { render :new, notice: 'biggest dumb' }
  ...
  private
    ...
    def father_params
      params.require(:father).permit(:password,:password_confirmation,:name, :content)
    end
end
